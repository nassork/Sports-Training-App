...
namespace AthleticTrainingWebApp.Controllers
{
    public class SchoolsController : Controller
    {
        ...
        [HttpGet]
        public ViewResult SearchSchoolByName()
        {
            return View();
        }
        ...
        [HttpPost]
        public ViewResult SearchSchoolByName(string schoolName)
        {

            List<School> schools = School.SearchSchoolByName(schoolName);

            return View("SearchSchoolResult", schools);
